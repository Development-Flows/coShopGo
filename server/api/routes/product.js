...
router.post("/add", async (req, res) => {
  ...
  try {
    ...
    if (!firstColor.hasOwnProperty("modelCode") || !firstColor.hasOwnProperty("productId") || !firstColor.hasOwnProperty("variation") || !firstColor.hasOwnProperty("stock") || !firstColor.hasOwnProperty("priceSale")) return res.status(400).send({
      status: false,
      errorMessage: "Bad request"
    });
